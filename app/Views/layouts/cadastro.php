...
<head>
    ...
    <?php
    $footerTitle = $footerTitle ?? 'Complete seu cadastro';
    // Verifica se `$showProgressBar` foi definido na página, caso contrário define como true
    $showProgressBar = $showProgressBar ?? true;
    // Define `currentStep` como padrão 1 se não foi especificado
