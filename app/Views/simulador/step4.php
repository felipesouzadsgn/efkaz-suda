    ...
    <form action="<?= base_url('/simulador/save') ?>" method="post" class="align-self-center" id="stepForm">
            ...
            <div class="row mb-3">
                ...
                <div class="col-6 text-end">
                    <div class="form-check form-switch d-inline-block">
                        <input class="form-check-input" type="checkbox" role="switch" id="oferta-0-switch"
                            name="oferta_0_switch" checked disabled>
        ...
        <div class="row bg-light px-3 mb-3 oferta-card" data-oferta-id="1" id="oferta-1">
            ...
            <div class="row">
                ...
                <div class="col-6 text-end p-3 align-itens-center">
                    <div class="form-check form-switch d-inline-block">
                        <input class="form-check-input oferta-switch" data-oferta-id="1" type="checkbox" role="switch"
                            name="oferta_1_switch" id="oferta-1-switch" checked>
        ...
        <div class="row bg-light px-3 mb-3 oferta-card" data-oferta-id="2" id="oferta-2">
            ...
            <div class="row">
                ...
                <div class="col-6 text-end p-3 align-itens-center">
                    <div class="form-check form-switch d-inline-block">
                        <input class="form-check-input oferta-switch" data-oferta-id="2" type="checkbox" role="switch"
                            name="oferta_2_switch" id="oferta-2-switch">
